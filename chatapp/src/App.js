...
import {getFirestore,addDoc, collection,onSnapshot, serverTimestamp, query,
...
function App() {
  ...
  <Box bg={"#212529"}>
    ...
    </Container>):(<VStack bg={"#212529"} justifyContent={"center"} alignItems={"center"} h="100vh">
      <Button onClick={loginHandler} colorScheme={"purple"} width={"30vw"}>Sign in with Google</Button>
      <Button onClick={homepage}  colorScheme={"green"} width={"30vw"}>Return to Home Page</Button>
    </VStack>)
    }
  </Box>
  );
